...
class _SchermataAggiungiState extends State<SchermataAggiungi> {
  ...
  Future<void> _aggiungi() async {
    if (_formKey.currentState!.validate()) {
      final nuovoVinile = Vinile(titolo: _titoloController.text.trim(), nomeArtista: _artistaController.text.trim(),
                    ...
                    quantita: _quantita, condizione: Condizione.values[_condizione], urlImmagine: _immagineFile?.path ?? 'vinile.jpeg',preferito: _preferito,);
